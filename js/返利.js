...
function handle() {
    ...
    clickNonClickableN("开心收下", 1, 3, 500);
    sleep(4100);
    if (text("去完成").exists()) {
    ...
    //见鬼！for和while都不好使
    for (i = 0; i < 2; i++) {
        clickNonClickableN("20221031110438_10356", 3, 2, 4000);
        sleep(52.5 * 1000);
        clickNonClickableN("| 跳过", 1, 2, 500);
        sleep(5000);

        clickNonClickableN("20221031110438_10356", 2, 2, 4000);
        sleep(52.5 * 1000);
        clickNonClickableN("| 跳过", 1, 2, 500);
        sleep(5000);

        clickNonClickableN("20221031110438_10356", 1, 2, 4000);
        sleep(52.5 * 1000);
        clickNonClickableN("| 跳过", 1, 2, 500);
        sleep(5000);
    }
